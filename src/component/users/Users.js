...
import { MyBlackTable } from './custom_table'
...
import jsonData from '../addUser/companies.json';
...
const Users = () => {
  ...
  const getNamesOnly = (data) => {
    let names = [];
    data.map((item, index) => names.push(item.fname));
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "verified",
      render: (source, item) => {
        return <div className="users-dropdown d-flex position-relative">
                  <img
                    ...
                    aria-expanded="false"
                    onClick={() => handleUserStatus(source)}
                  />
                    ...
                    <div className="sub1-users-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                      ...
                      <div>
                        ...
                        <Modal
                          ...
                          closable={false}
                          title={`Are You Sure to Delete the user ${deletingUser?.fname}?`}
                          open={isModalOpen}
                          okText="NO"
                          cancelText="YES"
                          onOk={handleCancel}
                          onCancel={() => handleRemoveUser(deletingUser?.email)}
                        />
                      </div>
                      <div
                        className="d-flex align-items-center cursor-pointer"
      ...
      {!isMobile ? (
        <div className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="sub2-div1 d-flex flex-column justify-content-end align-items-end w-100">
            <div className="subsub1-sub2-div1 bg-white d-flex flex-column py-2 w-100">
              ...
              <div className="sub2-subsub1-sub2-div1 d-flex justify-content-between align-items-center">
                ...
                <select className="field-select">
                  ...
                  { companies.map(c => (<option key={c.value} value={c.value}>{c.display}</option>))}
                </select>
                <select
            ...
            <div className="div2">
              <MyBlackTable columns={columns} dataSource={data} pagination={false} bordered = {false} showSorterTooltip={false} />
            </div>
          </div>
        </div>
      ) : (
        <div className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div
            className={`sub2-div2 d-flex flex-column px-4 w-100 overflow-auto ml-0 ${searchFold && "folded"
              }`}
          >
            {data?.map((item, index) => {
              return (
                              ...
                              <div className="sub1-users-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                                ...
                                <div>
                                  ...
                                  <Modal
                                    ...
                                    okText="YES"
                                    cancelText="NO"
                                    onOk={() => handleRemoveUser(item?.email)}
