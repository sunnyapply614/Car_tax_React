          ...
          <div className="sub2-div1 d-flex flex-column justify-content-end align-items-end w-100">
            ...
            <div className="div2">
              <div className="subsub1-sub1-users-div2 py-3">
                ...
                <p className="mb-0 text-center">City & Country</p>
                  ...
                  return (
                    <div id="import-users" key={index}>
                      ...
                      <div className="subsub1-sub2-users-div2">
                        <div className="item">
                          {isAuthenticated ? (<div>
                            <span className="item-dot-active"></span>
                          </div>) : (<div>
                            <span className="item-dot-deactive"></span>
                          </div>)}
                        </div>
                        ...
                        <p className="item item-fname">{item?.fname}</p>
                        <p className="item item-username">{item?.lname}</p>
                        <p className="item item-email">{item?.email}</p>
                        <p className="item item-phone">{item?.phone}</p>
                        <p className="item item-company">{item?.company}</p>
                        <p className="item item-role">{item?.role}</p>
                        <p className="item item-country">{item?.country}</p>
                        <p
