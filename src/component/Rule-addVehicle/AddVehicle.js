...
const AddVehicle = () => {
  ...
  useEffect(() => {
    setData(
      AddVehicle.filter((item) => {
        return (
          (searchPlateText == "Plate"
            ? item.plate
            : !searchPlateText || item.plate === searchPlateText) &&
          (!searchImeiText ||
            item.iemi
              .toLocaleLowerCase()
          ...
          (searchCompanyText == "Company"
            ? item.company
            : !searchCompanyText || item.company === searchCompanyText)
        );
      })
    );
  }, [
  ...
  const handleChange = (e) => {
    ...
    if (name === "allSelect") {
      let tewmpUser = data.map((da) => {
        return { ...da, isChecked: checked };
      });
      setData(tewmpUser);
    } else {
      let tewmpUser = data.map((da) =>
        da.plate === name ? { ...da, isChecked: checked } : da
      );
      setData(tewmpUser);
    }
  };
      ...
      {!isMobile ? (
            ...
            <div className="subsub1-sub2-div1 bg-white d-flex flex-column py-2 w-100">
              ...
              <div className="sub2-subsub1-sub2-div1 d-flex justify-content-between align-items-center">
                <select
                  ...
                  style={{
                    color: searchPlateText == "Plate" ? "#7A7D8B" : "black",
                  }}
                >
                ...
                <select
                  ...
                  style={{
                    color: searchDeviceText == "Device" ? "#7A7D8B" : "black",
                  }}
                >
                  <option selected value="Device">
                    Device
                  </option>
                  <option value="Teltonika" style={{ color: "black" }}>
                    Teltonika
                  </option>
                  <option value="Ruptela" style={{ color: "black" }}>
                    Ruptela
                  </option>
                </select>
                <select
                  ...
                  style={{
                    color: searchModelText == "Model" ? "#7A7D8B" : "black",
                  }}
                >
                ...
                <select
                  ...
                  style={{
                    color: searchCompanyText == "Company" ? "#7A7D8B" : "black",
                  }}
                >
              ...
              <div className="subsub1-sub1-addvehicle-div2 py-3">
                <div className="mb-0 d-flex justify-content-center align-items-center">
                  <input
                    ...
                    name="allSelect"
                    checked={
                      data.filter((da) => da?.isChecked !== true).length < 1
                    }
                  />
                </div>
        ...
        <div className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="d-flex mt-3 w-100 ml-5 pl-3">
            ...
            <p
              className="mb-0 ml-3"
              style={{ fontSize: "1.8rem", fontFamily: "rregular" }}
            >
              Select All
            </p>
          </div>
