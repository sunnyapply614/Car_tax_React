...
const AddDevice = () => {
  ...
  const handleData = (e) => {
    if (formData.devicetype == "Teltonika")
      Teltonikas.map((item) => {
        if (item.device == e.target.value) setPath(item.path);
      });
    else {
      Ruptelas.map((item) => {
        if (item.device == e.target.value) setPath(item.path);
  ...
  return (
    <div className="add-device-main w-100 h-100">
      ...
      <div className="add-device-div1 d-flex flex-column align-items-center p-5 mx-5">
          ...
          <div className="left-subsub1-sub1-add-device-div1 w-50 d-flex flex-column justify-content-evenly align-items-center">
            ...
            <div className="add-input-container d-flex flex-column mb-4">
              ...
              >
                ...
                {!!userList.length &&
                  userList.map((item) => {
                    return <option>{item.lname}</option>;
                  })}
              </select>
            </div>
            {/* <div className="add-input-container d-flex flex-column mb-4">
            ...
            <div className={`d-flex flex-column ${!isMobile && "p-5 sensors"}`}>
              ...
              <div
                className={`add-input-container d-flex align-items-end ${
                  isMobile && "flex-row"
                }`}
              >
                ...
                <img
                  className="ml-4 mb-3 col-4"
                  src={
                    Cameras.filter((item) => item.label === formData.camera)[0]
                      ? Cameras.filter(
                          (item) => item.label === formData.camera
                        )[0].path
                      : "./assets/image 11.png"
                  }
                  alt="none"
          ...
          {!isMobile ? (
            <div className="right-subsub1-sub1-add-device-div1 w-50 d-flex flex-column p-5">
              ...
              <div className="d-flex">
                ...
                <img
                  className="col-4 h-100 object-fit-cover"
                  src={path}
                  alt="none"
                />
              </div>
            ...
            <div className={`d-flex align-items-end ${isMobile && "w-100"}`}>
              ...
              <img
                className="ml-4 mb-3 mobile-image col-4"
                src={path}
                alt="none"
              />
            </div>
        ...
        <div
          className="sub5-right-subsub1-sub1-add-device-div1 d-flex justify-content-center w-100"
