...
const Ticket = () => {
      ...
      ticketsData.filter((item) => {
        return (
          (!searchRefText ||
            item.reference
              .toLocaleLowerCase()
              .includes(searchRefText.toLocaleLowerCase())) &&
          (!searchSubjectText ||
            item.subject
              .toLocaleLowerCase()
              .includes(searchSubjectText.toLocaleLowerCase())) &&
          (searchUserText == "User"
            ? item.user
            : !searchUserText || item.user === searchUserText) &&
  ...
  const handleChange = (e) => {
    ...
    if (name === "allSelect") {
      ...
      let tewmpUser = data.map((da) =>
        da.reference === name ? { ...da, isChecked: checked } : da
      );
      setData(tewmpUser);
    }
  };
            ...
            <div className="subsub1-sub2-div1 bg-white d-flex flex-column py-2 w-100">
              ...
              <div className="sub2-subsub1-sub2-div1 d-flex justify-content-between align-items-center">
                ...
                <select
                  ...
                  onChange={handleUser}
                  style={{
                    color: searchUserText == "User" ? "#7A7D8B" : "black",
                  }}
                >
                  <option>User</option>
                    ...
                    <div key={index} id="import-ticket">
                      ...
                      <div className="subsub1-sub2-ticket-div2">
                        ...
                        <p
                          ...
                          style={{
                            color:
                              item.status == "Resolved" ? "#63D16E" : "#FF3062",
                          }}
                        >
                          {item.status}
                        </p>
                          ...
                          <div className="dropdown-menu ticket-dropdown-div">
                            <div className="sub1-company-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                              <div
                                ...
                                onClick={() =>
                                  handleDialogBoxTicketState(ticketStatus)
                                }
                              >
                                <img
                                  src={
