...
const AddUser = () => {
    ...
    return (
        <div className="add-user-main w-100 h-100 ">
            <p>Add User</p>
            <div className='add-user-div1 d-flex flex-column p-5 mx-5'>
                ...
                <div className='add-input-container d-flex justify-content-evenly mb-5 gap-3'>
                    <div className='form-group d-flex flex-column position-relative'>
                        ...
                        <input className='form-control normal-input' name='country' type='text' value={formData.country} onChange={handleData} required />
                        {formData.country && (
