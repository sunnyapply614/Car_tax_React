    ...
    setData(
      ReportData.filter((item) => {
        return (
          ...
          (searchDeviceText === "Device Type"
            ? item.device
            : !searchDeviceText || item.device === searchDeviceText) &&
          (searchModelText === "Device Model"
            ? item.model
            : !searchModelText || item.model === searchModelText) &&
        ...
        <div className="d-flex flex-column justify-content-center align-items-center">
          <div className="sub1-div1 d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex position-relative">
              ...
              {isDropdownDisplayed && (
                <div
                  className="portal-report-types bg-white position-absolute p-3"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                  ref={dropdownRef}
            ...
            <div className="subsub1-sub2-div1 bg-white d-flex flex-column py-2 w-100">
              ...
              <div className="sub2-subsub1-sub2-div1 d-flex justify-content-between align-items-center">
                ...
                <select
                  ...
                  style={{
                    color:
                      searchDeviceText === "Device Type" ? "#7A7D8B" : "black",
                  }}
                >
                ...
                <select
                  ...
                  style={{
                    color:
                      searchModelText === "Device Model" ? "#7A7D8B" : "black",
                  }}
                >
                ...
                <select
                  ...
                  style={{
                    color:
                      searchCompanyText === "Company" ? "#7A7D8B" : "black",
                  }}
                >
