      ...
      CompanyData.filter((item) => {
        return (
          (!searchCompanyNameText ||
            item.companyName
              .toLocaleLowerCase()
              .includes(searchCompanyNameText.toLocaleLowerCase())) &&
          (!searchOwnerText ||
            item.owner
              .toLocaleLowerCase()
              .includes(searchOwnerText.toLocaleLowerCase())) &&
          (!searchEmailText ||
            item.email
              .toLocaleLowerCase()
          ...
          (searchCountryText == "Country"
            ? item.country_name
            : !searchCountryText || item.country_name === searchCountryText)
        );
      })
    );
  }, [
            ...
            <div className="subsub1-sub2-div1 bg-white d-flex flex-column py-2 w-100">
              ...
              <div className="sub2-subsub1-sub2-div1 d-flex justify-content-between align-items-center">
                ...
                <select
                  ...
                  style={{
                    color: searchCountryText == "Country" ? "#7A7D8B" : "black",
                  }}
                >
                          ...
                          <div className="dropdown-menu company-dropdown-div">
                            <div className="sub1-company-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                              ...
                              <div
                                ...
                                onClick={() =>
                                  handleDialogBoxCompanyState(companyStatus)
                                }
                              >
                                <img
                                  src={
                ...
                <div className="d-flex w-100">
                  ...
                  <div className="col-6 px-1">
                    <select
                      ...
                      style={{
                        color:
                          searchCountryText == "Country" ? "#7A7D8B" : "black",
                      }}
                    >
                      <option value="Country">Select Country</option>
                      {CountryData.map((item, index) => {
