        ...
        return (
          (!searchPlateText ||
            item?.vehicle?.vehicleName
              .toLocaleLowerCase()
              .includes(searchPlateText.toLocaleLowerCase())) &&
          (!searchImeiText ||
            item?.vehicle?.deviceImei
              .toLocaleLowerCase()
              .includes(searchImeiText.toLocaleLowerCase())) &&
          (searchDeviceText === "Device"
            ? item.vehicle.deviceType
            : !searchDeviceText ||
              item.vehicle.deviceType === searchDeviceText) &&
          (searchStatusText === "Status"
            ? item.vehicle.isConnected
            : !searchStatusText ||
              item.vehicle.isConnected === searchStatusText) &&
          (searchModelText === "Model"
            ? item.vehicle.deviceModel
            : !searchModelText || item.vehicle.deviceModel === searchModelText)
        );
      })
    );
  }, [
          ...
          <div className="sub2-div1">
            <div className="subsub1-sub2-div1 py-2">
              ...
              <div className="sub2-subsub1-sub2-div1">
                ...
                <select
                  ...
                  style={{
                    color: searchDeviceText == "Device" ? "grey" : "black",
                  }}
                >
                  <option key={0} selected value="Device">
                    Device
                  </option>
                  <option key={1} value="Teltonika">
                    Teltonika
                  </option>
                  <option key={2} value="Ruptela">
                    Ruptela
                  </option>
                </select>
                <select
                  ...
                  style={{
                    color: searchModelText == "Model" ? "grey" : "black",
                  }}
                >
                ...
                >
                  ...
                  <option style={{ color: "#63D16E" }} value="Connected">
                    Connected
                  </option>
                  <option style={{ color: "#FF3062" }} value="Not Connected">
                    Not Connected
                  </option>
                  <option style={{ color: "#7A7D8B" }} value="Idle">
                    Idle
                  </option>
                </select>
                <div
            ...
            <div className="div2">
                        ...
                        <div className="import-gps-time-devices item">
                          <p className="text-center">
                            ...
                            <span
                              ...
                              onClick={() =>
                                handleLocationClick(
                                  item?.vehicle?.teltonikas?.at(
                                    item?.vehicle?.teltonikas - 1
                                  )
                                )
                              }
                          ...
                          style={{
                            color:
                              item?.vehicle?.isConnected == "Connected"
                                ? "#63D16E"
                                : item?.vehicle?.isConnected == "Not Connected"
                                ? "#FF3062"
                                : "#7A7D8B",
                          }}
                        >
                          ...
                          <div className="dropdown-menu devices-dropdown-div">
                            <div className="sub1--devices-dropdown-div mx-4 d-flex flex-column justify-content-evenly h-100">
                              ...
                              <div
                                className="d-flex align-items-center cursor-pointer"
                                onClick={() =>
                                  handleRemoveDevice(item?.vehicle?.deviceImei)
                                }
                              >
              ...
              <div
                ...
                style={{ display: deviceRemove, lineHeight: ".5rem" }}
              >
